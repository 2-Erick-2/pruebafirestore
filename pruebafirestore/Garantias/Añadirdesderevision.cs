...
{
    public partial class Añadirdesderevision : Form
    {
        ...
        public Añadirdesderevision()
        {
            InitializeComponent();
        }

        private void Añadirdesderevision_Load(object sender, EventArgs e)
        {
        ...
        {
            garantiadesderevision crear = new garantiadesderevision();
            crear.Orden = Orden;
            crear.Nombre = Nombre;
            crear.Numero = Numero;
            crear.Modelo = Modelo;
